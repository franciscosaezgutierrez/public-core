...
def main():
    ...
    payload = {
        ...
        "operational_checklist": ["¿Drawdown ≥ -10%?", "¿VIX > 30?", "¿Liquidez suficiente?", "¿Peso actual < límite aplicable?", "¿Orden ≥ 50 €?", "¿No se mezclan capas?"],
        ...
        "operational_card": {
            "purchases": "gap vs objetivo · mínimo 50 € · no forzar inversión · sobrante a liquidez",
